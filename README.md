...
How to Use
Load the Sakila-derived CineFlix schema into a MySQL instance.
Open input.txt to find any of the 10 SQL queries.
Run the desired query against your database.
Compare your results with the sample outputs in output.txt.
